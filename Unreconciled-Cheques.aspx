<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Unreconciled-Cheques.aspx.cs" Inherits="Unreconcilled_Cheques" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Unreconciled Cheques <small>Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Unreconciled Cheques</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Voucher No"></asp:Label></div>
                                   ...
                                   <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label3" runat="server" Text="Voucher Date"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="Bank"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label4" runat="server" Text="Currency"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                   ...
                                   <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label5" runat="server" Text="Ex.Rate"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label6" runat="server" Text="Cheque No"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                   ...
                                   <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label7" runat="server" Text="Cheque Date"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
