                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Receipt <small></small></h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <br />  <div class="row">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label3" runat="server" Text="Receipt"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label6" runat="server" Text="Payee Name"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label9" runat="server" Text="TDS Amount"></asp:Label></div>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label11" runat="server" Text="TDS Account"></asp:Label></div>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label13" runat="server" Text="Cheque Bank"></asp:Label></div>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label7" runat="server" Text="Note"></asp:Label></div>
                                                           
                                                               <div class="col-lg-8 col-md-8">
                                                         
                                                               <asp:TextBox ID="TextBox12" runat="server" class="txt" TextMode="MultiLine"></asp:TextBox>
