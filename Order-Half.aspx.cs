...
public partial class Order_Half : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        conn.Open();
        SqlCommand cmd = new SqlCommand("SELECT * FROM orderhalf WHERE orderhalf =@orderhalf", conn);
        DataSet ds = new DataSet();

        SqlDataAdapter da = new SqlDataAdapter(cmd);
        cmd.Parameters.AddWithValue("@orderhalf", this.TextBox1.Text.Trim());
        ...
        {
            string message = "This orderhalf is already added!";
        ...
        else if (TextBox1.Text != "")
        {
            ...
            cmd1.Parameters.AddWithValue("@orderhalf", TextBox1.Text);
