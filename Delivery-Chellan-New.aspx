<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Delivery-Chellan-New.aspx.cs" Inherits="Delivery_Chellan_New" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Delivery Chellan New <small></small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Delivery Chellan New Entry</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-2 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="DC.No "></asp:Label></div>
                                 ...
                                 <div class="col-sm-6">
                                     <div class="form-group">
                                                            <div class="col-lg-2 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="DC Date "></asp:Label></div>
                                                            <div class="col-lg-10 col-md-9">
                                ...
                                <br />
                                 ...
                                 <div class="col-sm-6">
                                                                        <div class="form-group">
                                                            <div class="col-lg-2 col-md-3 control-label"> <asp:Label ID="Label3" runat="server" Text="P.O No "></asp:Label></div>
                                                            <div class="col-lg-10 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                       <div class="form-group">
                                                            <div class="col-lg-2 col-md-3 control-label"> <asp:Label ID="Label4" runat="server" Text="P.O Date "></asp:Label></div>
                                                            <div class="col-lg-10 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                      <div class="form-group">
                                                            <div class="col-lg-2 col-md-3 control-label"> <asp:Label ID="Label5" runat="server" Text="Party Id "></asp:Label></div>
                                                            <div class="col-lg-10 col-md-9">
                             ...
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-body">
                                     <div class="row">
                                       ...
                                       <div class="form-group">
                                                            <div class="col-lg-2 col-md-3 control-label"> <asp:Label ID="Label6" runat="server" Text="Total Quantity "></asp:Label></div>
                                                            <div class="col-lg-10 col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <br />   <div class="form-group">
                                                            <div class="col-lg-2 col-md-3 control-label"> <asp:Label ID="Label7" runat="server" Text="Narration "></asp:Label></div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Delivery Chellan Details</h4>
                                    <div class="panel-actions">
                                        <a href="#" class="panel-action panel-action-toggle" data-panel-toggle></a>
                                        <a href="#" class="panel-action panel-action-dismiss" data-panel-dismiss></a>
                                    </div>
...
<asp:GridView ID="GridView1" runat="server" Width="716px"></asp:GridView>
