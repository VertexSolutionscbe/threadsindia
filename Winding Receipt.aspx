<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Winding Receipt.aspx.cs" Inherits="Winding_Receipt" %>
...
<link href="http://ajax.aspnetcdn.com/ajax/jquery.ui/1.8.9/themes/blitzer/jquery-ui.css"
    ...
    <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
<script type="text/javascript" src="http://ajax.aspnetcdn.com/ajax/jquery.ui/1.8.9/jquery-ui.js" type="text/javascript"></script>
<link href="http://ajax.aspnetcdn.com/ajax/jquery.ui/1.8.9/themes/blitzer/jquery-ui.css"
    rel="stylesheet" type="text/css" />
             ...
             <div class="content-wrapper container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl"> Winding Receipt<small></small></h1>
               ...
               <div class="row">
                        <div class="col-md-12">
                            ...
                            <h4 class="panel-title">Winding Receipt</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                  <div class="col-sm-6">
                                                                        <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label4" runat="server" Text="Receipt Id* "  ></asp:Label> </div>
                                                           ...
                                                           <div class="col-sm-6">   <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Receipt Date* "  ></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
...
<ContentTemplate>
   <%-- <asp:Button ID="Button6" Text="Show Message" runat="server" OnClick="ShowMessage" />--%>
                                 ...
                                 <div class="col-sm-12">
                                      <div class="form-group">
                                      <div class="col-sm-6">
                                                            <div class="col-lg-3 col-md-1 control-label"> <asp:Label ID="Label5" runat="server" Text="Ref No*"></asp:Label></div>
                                                         ...
                                                         <%-- <asp:DropDownList ID="DropDownList3" runat="server" class="txt" Width="200px"></asp:DropDownList>
                                                              ...
                                                              <div class="col-sm-6">
                                                            <div class="col-lg-3 col-md-1 control-label"><asp:Label ID="Label6" runat="server" Text="Ref Date*"></asp:Label> </div>
                                                            <div class="col-lg-9 col-md-1">
 ...
 <div class="col-sm-2"><div class="form-group">
  ...
  <div class="col-sm-2"><div class="form-group">
                                    <div class="col-lg-6 col-md-6 control-label"> 
                                    <asp:Label ID="Label10" runat="server" Text="Bal Kgs"></asp:Label>
                                    </div>
  ...
  <div class="col-sm-2"><div class="form-group">
                                    ...
                                    <asp:Label ID="Label11" runat="server" Text="Boxes "></asp:Label>
                                    </div>
  ...
  <div class="col-sm-2"><div class="form-group">
                                    <div class="col-lg-6 col-md-6 control-label"> 
                                    <asp:Label ID="Label12" runat="server" Text="Tubes "></asp:Label>
                                    </div>
  ...
  <div class="col-sm-2"><div class="form-group">
                                    <div class="col-lg-6 col-md-6 control-label"> 
                                    <asp:Label ID="Label17" runat="server" Text="Cones "></asp:Label>
                                    </div>
                                    <div class="col-lg-9 col-md-8"><asp:TextBox ID="TextBox4" runat="server" Width="50px"></asp:TextBox> </div>
  ...
  <div class="col-sm-2"><div class="form-group">
                                    ...
                                    <div class="col-lg-9 col-md-8"><asp:TextBox ID="TextBox6" runat="server" Width="50px"></asp:TextBox> </div>

 </div></div>
  <div class="col-sm-2"><div class="form-group">
                                    <div class="col-lg-6 col-md-6 control-label"> 
                                    <asp:Label ID="Label19" runat="server" Text="Net Wt "></asp:Label>
                                    </div>
                                    <div class="col-lg-9 col-md-8"><asp:TextBox ID="TextBox7" runat="server" Width="50px"></asp:TextBox> </div>

 </div></div>
  <div class="col-sm-2"><div class="form-group">
                                    <div class="col-lg-6 col-md-6 control-label"> 
                                    <asp:Label ID="Label20" runat="server" Text="Will Kg "></asp:Label>
                                    </div>
                                    <div class="col-lg-9 col-md-8"><asp:TextBox ID="TextBox8" runat="server" Width="50px"></asp:TextBox> </div>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label13" runat="server" Text="Total G.Wt"></asp:Label></div>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label15" runat="server" Text="Total Cones"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
...
<br />                                  <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label16" runat="server" Text="Narration"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
