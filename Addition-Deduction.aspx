<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Addition-Deduction.aspx.cs" Inherits="Addition_Deduction" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Additional Deduction <small>Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Additional Deduction</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Template Description"></asp:Label></div>
                                                            ...
                                                            <asp:TextBox ID="TextBox1" runat="server" class="txt"></asp:TextBox>
                                                                   ...
                                                                   <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-1 col-md-3 control-label"> <asp:Label ID="Label6" runat="server" Text="ID"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="Transaction"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                     ...
                                     <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label7" runat="server" Text="Transaction Id"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label3" runat="server" Text="Transaction To Be"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                         ...
                                         <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label4" runat="server" Text="Palse Round Off"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
