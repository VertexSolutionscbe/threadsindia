<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Linked Accounts.aspx.cs" Inherits="Linked_Accounts" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Linked Accounts<small></small></h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <span class="pull-left">
                                            <img src="images/save.png" alt="" class="img-square" width="20"/>
                                        </span>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Currency Gain or Loss A/C "></asp:Label></div>
                                ...
                                <br />
                                 ...
                                 <div class="col-sm-6">
                                                                        <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label3" runat="server" Text="Round-Up Adjustment A/C "></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                      <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label5" runat="server" Text="Profit or Loss C/F A/C"></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                      <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="Stock Increase/Decrease A/C"></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                      <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label6" runat="server" Text="TDS in Customer's Receipt"></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                      <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label8" runat="server" Text="TDS in Supplier's Payment"></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
