<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AR-AP-Billwise-Opening-Balance.aspx.cs" Inherits="AR_AP_Billwise_Opening_Balance" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">AR/AP  BillWise Opening Balance <small>Details</small></h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">AR/AP  BillWise Opening Balance </h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Company"></asp:Label></div>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-3 control-label">  <asp:Label ID="Label3" runat="server" class="lbl" Text="Opening Balance as On"></asp:Label></asp:Label></div>
                                                            <div class="col-lg-6 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="Account Name"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-9">
                               ...
                               <br />  <div class="row">
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-3 control-label"> <asp:Label ID="Label4" runat="server" Text="Receivable and Payable Account"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-3 control-label"> <asp:Label ID="Label5" runat="server" Text="Trial Balance"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-3 control-label"> <asp:Label ID="Label6" runat="server" Text="Currency"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-9">
                                                           
                                                            <asp:DropDownList ID="DropDownList3" runat="server" class="txt"></asp:DropDownList> s
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">AR/AP Billwise Opening Balance Details</h4>
                                    <div class="panel-actions">
                                        <a href="#" class="panel-action panel-action-toggle" data-panel-toggle></a>
                                        <a href="#" class="panel-action panel-action-dismiss" data-panel-dismiss></a>
                                    </div>
                        ...
                        <div class="col-md-12">
                             ...
                             <br />  <div class="row">
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-3 control-label"> <asp:Label ID="Label7" runat="server" Text="Total Debits"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-3 control-label"> <asp:Label ID="Label8" runat="server" Text="Total Credits"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-3 control-label"> <asp:Label ID="Label9" runat="server" Text="Notes"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-9">
