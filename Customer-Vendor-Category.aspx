<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer-Vendor-Category.aspx.cs" Inherits="Customer_Vendor_Category" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Party Category <small>Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Party Category </h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Type" Visible="false"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                                           
                                                             <asp:DropDownList ID="DropDownList1" runat="server" class="txt" Visible="false"></asp:DropDownList>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="Category"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                              ...
                              <br />     <div class="row">
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"></div>
                                                            
                                                              <div class="col-lg-8 col-md-9">
                                                               <div class="col-lg-6 col-md-3 control-label"> <asp:CheckBox ID="CheckBox2" runat="server"></asp:CheckBox> <asp:Label ID="Label4" runat="server" Text="Inactive"></asp:Label></div>
                                                              </div>
                                                        </div>
