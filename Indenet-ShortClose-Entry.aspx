<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Indenet-ShortClose-Entry.aspx.cs" Inherits="Indenet_ShortClose_Entry" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Indent ShortClose Entry <small>Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Indent ShortClose Entry</h4>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="col-sm-8">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="Narrartion"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
