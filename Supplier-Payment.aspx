<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Supplier-Payment.aspx.cs" Inherits="Supplier_Payment" %>
...
<meta charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Supplier Payment<small></small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label2" runat="server" Text="Payment Date"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8">
                                  ...
                                  <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label3" runat="server" Text="Payment Number"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label4" runat="server" Text="Supplier"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8">
                                  ...
                                  <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label5" runat="server" Text="Paid Through"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label6" runat="server" Text="Currency"></asp:Label></div>
                                                            <div class="col-lg-4 col-md-8">
                                                           <asp:DropDownList ID="DropDownList5" runat="server" class="txt"></asp:DropDownList>
                                                               
                                                              
                                                            </div>
                                                            <div class="col-lg-4 col-md-8"><asp:TextBox ID="TextBox2" runat="server" class="txt"></asp:TextBox></div>
                                                        </div>
                                  ...
                                  <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-4 control-label"> <asp:Label ID="Label7" runat="server" Text="Actual Payment Amount"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8"> 
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label8" runat="server" Text="Reference Number"></asp:Label></div>
                                                            <div class="col-lg-4 col-md-8">
                                                          <asp:TextBox ID="TextBox4" runat="server" class="txt"></asp:TextBox>
                                                               
                                                              
                                                            </div>
                                                            <div class="col-lg-4 col-md-8"><asp:TextBox ID="TextBox5" runat="server" class="txt"></asp:TextBox></div>
                                                        </div>
                                  ...
                                  <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-4 control-label"> <asp:Label ID="Label9" runat="server" Text="TDS Amount"></asp:Label></div>
                                                            <div class="col-lg-4 col-md-8"> 
                                                               
                                                              <asp:TextBox ID="TextBox6" runat="server" class="txt"></asp:TextBox>
                                                            </div>
                                                             <div class="col-lg-4 col-md-8">
                                                             <asp:DropDownList ID="DropDownList7" runat="server" class="txt"></asp:DropDownList>
                                                              </div>
                                                        </div>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label10" runat="server" Text="Cheque Number"></asp:Label></div>
                                                            <div class="col-lg-4 col-md-8">
                                  ...
                                  <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-4 control-label"> <asp:Label ID="Label11" runat="server" Text="Payment Amount"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8"> 
                                ...
                                <br /> <div class="row">
                                   <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-4 control-label"> <asp:Label ID="Label12" runat="server" Text="Balance"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8"> 
                                  ...
                                  <br /> <div class="row">
                                   <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-4 control-label"> <asp:Label ID="Label13" runat="server" Text="Note"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8"> 
                                                               
                                                              <asp:TextBox ID="TextBox11" runat="server" class="txt" TextMode="MultiLine"></asp:TextBox>
                                                            </div>
   ...
   <br /> <div class="row">
                                   <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-4 control-label"> <asp:Label ID="Label14" runat="server" Text="Total Settled"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8"> 
                                     ...
                                     <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-4 control-label"> <asp:Label ID="Label15" runat="server" Text="On Account"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8"> 
                                   ...
                                   <br /><div class="row">
                                    <div class="col-sm-10 col-sm-offset-2">
                                      <div class="form-group">
                                                            <div class="col-sm-2"> <asp:Button ID="Button1" runat="server" Class="btn" Text="OK"></asp:Button></div>
