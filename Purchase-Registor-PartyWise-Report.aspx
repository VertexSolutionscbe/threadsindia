<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Purchase-Registor-PartyWise-Report.aspx.cs" Inherits="Purchase_Registor_PartyWise" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Purchase Registor Party wise  Report <small></small></h1>
                    ...
                    <div class="row">
                             ...
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Party Name"></asp:Label></div>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="From Date"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                     ...
                                     <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label4" runat="server" Text="To Date"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label3" runat="server" Text="Cash / Credit"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                 ...
                                 <br /><div class="row">
                                  ...
                                  <div class="col-sm-2"> <asp:Button ID="Button3" runat="server" Class="btn" Text="OK"></asp:Button></div></div>
                                                        </div>
                                 </div>          <br />
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Purchase Registor Party Wise Report Details</h4>
                                    <div class="panel-actions">
                                        <a href="#" class="panel-action panel-action-toggle" data-panel-toggle></a>
                                        <a href="#" class="panel-action panel-action-dismiss" data-panel-dismiss></a>
                                    </div>
