<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reconcile Account.aspx.cs" Inherits="Reconcile_Account" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Reconcile Accounts <small> Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Reconcile Accounts</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label1" runat="server" Text="Branch"></asp:Label></div>
                            ...
                            <br />  <div class="row">
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label2" runat="server" Text="Reconcile Ref"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label4" runat="server" Text="Bank Account"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label6" runat="server" Text="Bank Statement "></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8">
