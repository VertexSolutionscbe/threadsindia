<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Winding Delivery.aspx.cs" Inherits="Winding_Delivery" %>
             ...
             <div class="content-wrapper container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl"> Winding Delivery<small></small></h1>
               ...
               <div class="row">
                        <div class="col-md-12">
                            ...
                            <h4 class="panel-title">Winding Delivery</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                  <div class="col-sm-6">
                                                                        <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label4" runat="server" Text="DC Date* "  ></asp:Label> </div>
                                                            <div class="col-lg-9 col-md-8">
                                                                   <asp:TextBox ID="txtval2" runat="server" class="txt|" Width ="200px" ></asp:TextBox>
                                                                <asp:CalendarExtender ID="CalendarExtender1" PopupButtonID="imgPopup" runat="server" TargetControlID="txtval2" Format="dd/MM/yyyy" PopupPosition="Right"> </asp:CalendarExtender>  
                                                            </div>
                                                        </div>
                                 </div>
                                                           <div class="col-sm-6">   <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="DC No* "  ></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
