<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payable-With-Adjustment.aspx.cs" Inherits="Payable_With_Adjustment" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Payable With Adjustment<small></small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Payable With Adjustment</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label9" runat="server" Text="Payable Accounts"></asp:Label></div>
