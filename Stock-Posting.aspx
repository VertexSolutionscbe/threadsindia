<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Stock-Posting.aspx.cs" Inherits="Stock_Posting" %>
...
<head runat="server">
   <meta charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Stock Posting <small> Details</small></h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Stock Posting</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <br />  <div class="row">
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label4" runat="server" Text="Stock As On"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
                                    ...
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label12" runat="server" Text="TXN Number"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Stock Posting Details</h4>
                                    <div class="panel-actions">
                                        <a href="#" class="panel-action panel-action-toggle" data-panel-toggle></a>
                                        <a href="#" class="panel-action panel-action-dismiss" data-panel-dismiss></a>
                                    </div>
    ...
    <br />  <div class="row">
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label7" runat="server" Text="Total Stock Value"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
    ...
    <br />  <div class="row">
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-3 col-md-2 control-label"> <asp:Label ID="Label3" runat="server" Text="Remarks"></asp:Label></div>
