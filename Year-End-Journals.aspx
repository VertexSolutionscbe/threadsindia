<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Year-End-Journals.aspx.cs" Inherits="Year_End_Journalsaspx" %>
...
<meta charset="utf-8">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Year End Journals <small></small></h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Year End Journals</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label1" runat="server" Text="Company"></asp:Label></div>
                                  ...
                                  <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label9" runat="server" Text="Financial Year"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
                                 ...
                                 <br />  <div class="row">
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label2" runat="server" Text="Branch"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
                                                          ...
                                                          <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label10" runat="server" Text="Voucher Date"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
                                   ...
                                   <br />  <div class="row">
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label3" runat="server" Text="Voucher Number"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
                                    ...
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label11" runat="server" Text="Currency"></asp:Label></div>
                                  ...
                                  <br />  <div class="row">
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label4" runat="server" Text="Ref Date"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
                                    ...
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label12" runat="server" Text="Ref Number"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
                               ...
                               <br />  <div class="row">
                                   <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-6 col-md-2 control-label"> <asp:Label ID="Label6" runat="server" Text="Notes"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
                                                        <asp:TextBox ID="TextBox6" runat="server" class="txt" TextMode="MultiLine"></asp:TextBox>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Year End Journal Details</h4>
                                    <div class="panel-actions">
                                        <a href="#" class="panel-action panel-action-toggle" data-panel-toggle></a>
                                        <a href="#" class="panel-action panel-action-dismiss" data-panel-dismiss></a>
                                    </div>
    ...
    <br />  <div class="row">
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-3 col-md-2 control-label"> <asp:Label ID="Label7" runat="server" Text="Total Debit"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
                                  ...
                                  <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-3 col-md-2 control-label"> <asp:Label ID="Label8" runat="server" Text="Total Credit"></asp:Label></div>
                                                            <div class="col-lg-6 col-md-8">
