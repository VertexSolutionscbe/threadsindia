<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Winding Box Return.aspx.cs" Inherits="Winding_Box_Return" %>
             ...
             <div class="content-wrapper container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl"> Winding Box Return<small></small></h1>
               ...
               <div class="row">
                        <div class="col-md-12">
                            ...
                            <h4 class="panel-title">Winding Box Return</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                  <div class="col-sm-6">
                                                                        <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label4" runat="server" Text="Doc Id* "  ></asp:Label> </div>
                                                           ...
                                                           <div class="col-sm-6">   <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Doc Date * "  ></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
...
<ContentTemplate>
   <%-- <asp:Button ID="Button6" Text="Show Message" runat="server" OnClick="ShowMessage" />--%>
                                 ...
                                 <div class="col-sm-12">
                                      <div class="form-group">
                                      <div class="col-sm-6">
                                                            <div class="col-lg-3 col-md-1 control-label"> <asp:Label ID="Label5" runat="server" Text="Winding*"></asp:Label></div>
                                 ...
                                 <div class="col-sm-6">
                                      <div class="form-group">
                                                            <div class="col-lg-3 col-md-1 control-label"> <asp:Label ID="Label2" runat="server" Text="Purpose"></asp:Label></div>
                                                            <div class="col-lg-9 col-md-1">
 ...
 <%--<div class="col-sm-2"><div class="form-group">
  ...
  <%--<div class="col-sm-2"><div class="form-group">
                                    <div class="col-lg-6 col-md-6 control-label"> 
                                    <asp:Label ID="Label12" runat="server" Text="Net "></asp:Label>
                                    </div>
