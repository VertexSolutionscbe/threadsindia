<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MIS-Configurator.aspx.cs" Inherits="MIS_Configurator" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">MIS Configurator<small></small></h1>
                               ...
                               <br />
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                           <div class="col-sm-6">   <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Configuration ID* "></asp:Label></div>
                                 ...
                                 <div class="col-sm-12">
                                      <div class="form-group">
                                      <div class="col-sm-6">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label5" runat="server" Text="Item List"></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
                                                           
                                                          <asp:DropDownList ID="DropDownList3" runat="server" class="txt" Width="250px"></asp:DropDownList>
                                                            ...
                                                            <asp:Label ID="Label8" runat="server" Text="Caption"></asp:Label> </div> <asp:TextBox ID="txtval1" runat="server" class="txt" Width="200px"></asp:TextBox>
                                                            ...
                                                            <div class="col-lg-3 col-md-3 control-label"> </div></div>
                                                           <div class="col-sm-6">
