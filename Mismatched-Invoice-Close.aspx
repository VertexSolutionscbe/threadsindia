<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mismatched-Invoice-Close.aspx.cs" Inherits="Mismatched_Invoice_Close" %>
                        ...
                        <ul class="nav metismenu" id="side-menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="nav nav-second-level collapse">
                                    ...
                                    <li<li><a href="Purchase-Invoice.aspx">Purchase Invoice</a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Mismatched Invoice Close <small>Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Mismatched Invoice Close </h4>
