                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Location <small>Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Location Entry</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Location Type "></asp:Label></div>
                                ...
                                <br />
                                 ...
                                 <div class="col-sm-6">
                                                                        <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label3" runat="server" Text="Location Name "></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
                                 ...
                                 <div class="col-sm-6">
                                      <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label5" runat="server" Text="Address"></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
                                                           
                                                             <asp:TextBox ID="TextBox7" runat="server" Class="txt" TextMode="MultiLine"></asp:TextBox>
