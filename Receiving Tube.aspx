<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Receiving Tube.aspx.cs" Inherits="Winding_Tube" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl"> Receive Tube<small></small></h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel-heading">
                                       <h4 class="panel-title">Receive tube</h4>
...
<ContentTemplate>
   <%-- <asp:Button ID="Button6" Text="Show Message" runat="server" OnClick="ShowMessage" />--%>
                                 ...
                                 <div class="col-sm-12">
                                      <div class="form-group">
                                      <div class="col-sm-6">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label5" runat="server" Text="ReceiveTube*"></asp:Label></div>
                                                            <div class="col-lg-9 col-md-8">
                                                              <asp:TextBox ID="txtval2" runat="server" class="txt|" Width ="200px" ></asp:TextBox>

                                                              <asp:Label ID="Label4" runat="server" Text="ReceiveTubeCode*" Visible="false"></asp:Label>
