<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Business-Segment.aspx.cs" Inherits="Business_Segment" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Bussiness Segment <small>Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Bussiness Segment</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label1" runat="server" Text="Business Segment"></asp:Label></div>
                                ...
                                <br />
                                 ...
                                 <div class="col-sm-6">
                                                                        <div class="form-group">
                                                            <div class="col-lg-4 col-md-4 control-label"> <asp:Label ID="Label3" runat="server" Text="Applay On "></asp:Label></div>
                                                            <div class="col-lg-8 col-md-7">
