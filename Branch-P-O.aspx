<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Branch-P-O.aspx.cs" Inherits="Branch_P_O" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Branch PO <small>Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Branch PO</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="Doc Date"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label3" runat="server" Text="Total Cone"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                    ...
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label4" runat="server" Text="Total Qty"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
