<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mismatch-Mill-Pending-Report.aspx.cs" Inherits="Missmatch_Mill_Pending" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Mismatch Mill Pending <small>Report</small></h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Mismatch Mill Pending  Report Details</h4>
                                    <div class="panel-actions">
                                        <a href="#" class="panel-action panel-action-toggle" data-panel-toggle></a>
                                        <a href="#" class="panel-action panel-action-dismiss" data-panel-dismiss></a>
                                    </div>
