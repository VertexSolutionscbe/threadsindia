<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reconcilation-Report.aspx.cs" Inherits="Reconcilation_Report" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Reconcilation Report<small> Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Reconcilation Report</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label1" runat="server" Text="Account Name"></asp:Label></div>
                            ...
                            <br />  <div class="row">
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label2" runat="server" Text="As on"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-8">
