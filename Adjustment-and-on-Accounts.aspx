<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Adjustment-and-on-Accounts.aspx.cs" Inherits="Adjustment__and__on_Accounts" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Adjustment & on accounts<small></small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Adjustment & on accounts</h4>
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label1" runat="server" Text="Select Option"></asp:Label></div>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-3 col-md-2 control-label"> <asp:Label ID="Label9" runat="server" Text="Customer"></asp:Label></div>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-2 control-label"> <asp:Label ID="Label3" runat="server" Text="From"></asp:Label></div>
                                                            <div class="col-lg-7 col-md-8">
                                    ...
                                    <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-1 col-md-2 control-label"> <asp:Label ID="Label4" runat="server" Text="To"></asp:Label></div>
                                                            <div class="col-lg-7 col-md-8">
