<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Goods-Received-Summary-Report.aspx.cs" Inherits="Goods_Received_Summary_Report" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Goods Received  <small>Summary</small></h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="To Date"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                 ...
                                 <br /><div class="row">
                                  ...
                                  <div class="col-sm-2"> <asp:Button ID="Button1" runat="server" class="btn" Text="Button"></asp:Button></div></div>
                                                        </div>
                                 </div>          <br />
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                <!-- Start .panel -->
                                <div class="panel-heading">
                                    <h4 class="panel-title">Goods Received Summary Report Details</h4>
                                    <div class="panel-actions">
                                        <a href="#" class="panel-action panel-action-toggle" data-panel-toggle></a>
                                        <a href="#" class="panel-action panel-action-dismiss" data-panel-dismiss></a>
                                    </div>
