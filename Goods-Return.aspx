<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Goods-Return.aspx.cs" Inherits="Goods_Return" %>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title">
                                <h1 class="gnrl">Goods Return <small>Details</small></h1>
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Goods Return Details</h4>
...
<asp:TextBox ID="TextBox1" runat="server" class="txt"></asp:TextBox>
                                 ...
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label2" runat="server" Text="Ref No"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
...
<asp:DropDownList ID="DropDownList1" runat="server" class="txt"></asp:DropDownList>
                                             ...
                                             <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label5" runat="server" Text="Mll del compleated"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                        ...
                        <div class="col-md-12">
                             <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-body">
                                 ...
                                 <div class="col-sm-4">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label6" runat="server" Text="Total Bags"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
<asp:TextBox ID="TextBox4" runat="server" class="txt"></asp:TextBox>
                                             ...
                                             <div class="col-sm-4">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label7" runat="server" Text="Gross.Wt"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                                        ...
                                                        <asp:TextBox ID="TextBox5" runat="server" class="txt"></asp:TextBox>
                                                                              ...
                                                                              <div class="col-sm-4">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label8" runat="server" Text="Net.Wt"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                                 ...
                                 <div class="col-sm-4">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label9" runat="server" Text="Packed By"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
<asp:TextBox ID="TextBox7" runat="server" class="txt"></asp:TextBox>
                                             ...
                                             <div class="col-sm-4">
                                 <div class="form-group">
                                                            <div class="col-lg-4 col-md-3 control-label"> <asp:Label ID="Label10" runat="server" Text="Checked By"></asp:Label></div>
                                                            <div class="col-lg-8 col-md-9">
                              ...
                              <br />       <div class="row">
                                 <div class="col-sm-6">
                                 <div class="form-group">
                                                            <div class="col-lg-3 col-md-3 control-label"> <asp:Label ID="Label11" runat="server" Text="Narration"></asp:Label></div>
